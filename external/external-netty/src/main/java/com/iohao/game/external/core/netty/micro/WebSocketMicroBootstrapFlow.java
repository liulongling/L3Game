...
public class WebSocketMicroBootstrapFlow extends SocketMicroBootstrapFlow {
    ...
    public void option(ServerBootstrap bootstrap) {
        System.out.println(" Test WebSocketMicroBootstrapFlow option");
        bootstrap
                // 客户端保持活动连接
    ...
    public void pipelineCodec(PipelineContext context) {
        System.out.println(" Test WebSocketMicroBootstrapFlow pipelineCodec");
        // 添加 http 相关 handler
    ...
    protected void websocketHandler(PipelineContext context) {
        System.out.println(" Test WebSocketMicroBootstrapFlow websocketHandler");
        // WebSocket 数据压缩
